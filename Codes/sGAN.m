...
layersGenerator = [
    ...
    transposedConv2dLayer(filterSize,4*numFilters,'Stride',1,'Name','tconv1')
    batchNormalizationLayer('Name','bnorm1')
    reluLayer('Name','relu1')
    transposedConv2dLayer(filterSize,2*numFilters,'Stride',1,'Name','tconv2')
    batchNormalizationLayer('Name','bnorm2')
    reluLayer('Name','relu2')
    transposedConv2dLayer(filterSize,numFilters,'Stride',1,'Name','tconv3')
    batchNormalizationLayer('Name','bnorm3')
    reluLayer('Name','relu3')
    transposedConv2dLayer(filterSize,1,'Stride',1,'Name','tconv4')
    tanhLayer('Name','tanh')];
...
layersDiscriminator = [
    ...
    convolution2dLayer(filterSize,numFilters,'Stride',1,'Padding',2,'Name','conv1')
    batchNormalizationLayer('Name','bn1')
    leakyReluLayer(scale,'Name','lrelu1')
    convolution2dLayer(filterSize,2*numFilters,'Stride',1,'Padding',2,'Name','conv2')
    batchNormalizationLayer('Name','bn2')
    leakyReluLayer(scale,'Name','lrelu2')
    convolution2dLayer(filterSize,4*numFilters,'Stride',1,'Padding',2,'Name','conv3')
    batchNormalizationLayer('Name','bn3')
    leakyReluLayer(scale,'Name','lrelu3')
    convolution2dLayer(filterSize,8*numFilters,'Stride',1,'Padding',2,'Name','conv4')
...
for epoch = 1:numEpochs
    ...
    %display(endflag);
      %  Read mini-batch of data.
       if (mod(fix(epoch/10),4) == 0 || epoch<100)
        dlX = next(mbq);
        dlX1 = next(mbq1);
        dlX2 = next(mbq2);
        dlX3 = next(mbq3);
